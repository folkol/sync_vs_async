...
#    n=$((2 ** $threads))
#    ab -k -n 10000 -c $n http://$HOST:8080/sync/tiny_few >results/tiny_few_$n.json
#done
#echo "Waiting..."
#sleep 30
...
#    n=$((2 ** $threads))
#    ab -k -n 1000 -c $n http://$HOST:8080/sync/tiny_many >results/tiny_many_$n.json
#done
#echo "Waiting..."
#sleep 30
...
#for threads in {0..10}; do
#    n=$((2 ** $threads))
#    ab -k -n 10000 -c $n http://$HOST:8080/async/tiny_few >results/tiny_few_$n.json
#done
#echo "Waiting..."
#sleep 30
...
#for threads in {0..9}; do
#    n=$((2 ** $threads))
#    ab -k -n 1000 -c $n http://$HOST:8080/async/tiny_many >results/tiny_many_$n.json
#done
#echo "Waiting..."
#sleep 30
